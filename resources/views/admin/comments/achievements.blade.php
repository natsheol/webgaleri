...
<div class="container-fluid px-4">
    <h1 class="mt-4">Achievement Comments</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-info">All Comments ({{ $comments->total() }})</h6>
        </div>
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($comment->achievement)
                                        <small>{{ Str::limit($comment->achievement->title, 50) }}</small>
                                    @else
                                        <span class="text-muted">Achievement Deleted</span>
                                    @endif
                                </td>
