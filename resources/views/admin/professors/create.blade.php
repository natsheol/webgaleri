...
<div class="container mx-auto px-6 py-8">
    ...
    <form action="{{ route('admin.professors.store') }}" method="POST" class="bg-white p-6 rounded shadow space-y-4">
        @csrf
        ...
        <div>
            ...
            <input type="text" name="position" value="{{ old('email') }}" class="w-full border rounded p-2">
        </div>
